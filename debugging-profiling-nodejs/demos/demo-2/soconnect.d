...
/* Slight adaptation from: http://dtracebook.com/index.php/Network_Lower_Level_Protocols:soconnect.d#Mac_OS_X
   in order to print ustack and limit process to node.
*/
...
syscall::connect*:entry /execname=="node"/ {
...
syscall::connect*:entry /execname=="node" && this->f == af_inet/ {
	self->family = this->f;
...
syscall::connect*:return /execname=="node" && self->start/ {
